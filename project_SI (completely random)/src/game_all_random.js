    ...
    case this.STATE_PLAY:
           ...
           //PLAYER LOOP
            this.playerGroup.forEachAlive(function(player){
                ...
                if (player.alive && player.index != 0 ) this.GA.activateBrain(player,this.textGroup.getAt(1),player.distToBorder,player.distToTarget,player.heightDist,player.heightToNextBorder);
